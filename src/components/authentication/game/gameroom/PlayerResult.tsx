...
export const PlayerResult = (props: PlayerResultProps) => {
    ...
    React.useEffect(() => {   
        ...
        const playerIndex: number = getPlayerCurrentPositionInRoomSecondary(props.address, context.getter.room);
        setPlayer(context.getter.room.players[playerIndex]);
        setCode(context.getter.room.code);
        const hand: Hand | undefined = context.getter.room.players[playerIndex].hand
        console.log(hand)
